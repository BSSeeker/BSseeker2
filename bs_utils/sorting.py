...
'''
nohup python sorting.py  -k "str(line[0:2]),int(line[3:13])" reduced-sample1.ali sorted-sample1.ali &
    ...
    try:
        ...
        try:
            for tempdir in cycle(tempdirs):
                ...
                #print current_chunk[0][20:22];
                #print current_chunk[0][0:4];
                #print current_chunk[0][5:16];
                #break;
                if current_chunk:
